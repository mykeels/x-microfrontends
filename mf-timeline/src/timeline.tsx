      ...
      <section className="flex flex-col feed grow outline outline-purple-400">
        ...
        <div className="post-container flex-start">
          ...
          <div className="post-text-container">
            ...
            <p>
              If you <em>ONLY</em> know HTML and CSS it is going to be VERY hard
              to land your first job in tech as a software developer. <br />
              <br />
              You might have a chance to do some freelancing but the reality is,
              you are going to need to know more in order to be marketable in
              the industry.
            </p>
